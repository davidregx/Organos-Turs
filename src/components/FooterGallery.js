      ...
      >
        ...
        >
          <div className="bg-white rounded-xl p-2 flex flex-col items-center text-center shadow-lg h-64 w-full">
            ...
            <DynamicCarousel items={restaurantsData} type="restaurant" navigateTo="/restaurants" carouselDelay={0} /> {/* Delay 0 */}
          </div>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-xl p-2 flex flex-col items-center text-center shadow-lg h-64 w-full">
            ...
            <DynamicCarousel items={toursData} type="tour" navigateTo="/tours" carouselDelay={1} /> {/* Delay 1 segundo */}
          </div>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-xl p-2 flex flex-col items-center text-center shadow-lg h-64 w-full">
            ...
            <DynamicCarousel items={Object.values(shopCategoriesData)} type="shopCategory" navigateTo="/shop" carouselDelay={2} /> {/* Delay 2 segundos */}
          </div>
        </motion.div>
